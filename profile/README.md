...
<p align="center">
  Readmigo helps language learners improve their English through immersive reading experiences with AI-assisted comprehension tools. Access 100,000+ classic books and 20,000+ audiobooks — all free.
</p>
...
- **Multi-Platform** — Available on iOS, Android (Coming Soon), and Web
...
| [typesetting](https://github.com/readmigo/typesetting) | Cross-platform typesetting engine with Standard Ebooks CSS support | C++ |
...
| [voxclone](https://github.com/readmigo/voxclone) | AI Voice Cloning — personalized messages in 18+ dialects | Swift |
...
| [blog](https://github.com/readmigo/blog) | Official Readmigo blog | HTML |
| [docs](https://github.com/readmigo/docs) | Project documentation (VitePress) | TypeScript |
...
- **NLP**: Python, spaCy
- **Typesetting**: C++, Standard Ebooks CSS
...
| Readmigo | Web | [app.readmigo.com](https://app.readmigo.com) |
...
| Documentation | Web | [readmigo.github.io/docs](https://readmigo.github.io/docs/) |
